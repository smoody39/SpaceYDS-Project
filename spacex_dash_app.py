...
def get_pie_chart(entered_site):
                                    ...
                                    if entered_site == 'ALL':
                                        ...
                                        # Filter data for successful launches for the selected site
                                        success_df = filtered_df[filtered_df['LaunchSite'] == entered_site]
                                        ...
                                        fig = px.pie(
                                            ...
                                            values='class',
                                            names='Launch Site',
                                            title=f"Success Counts for Launch Site: {entered_site}"
                                        )
